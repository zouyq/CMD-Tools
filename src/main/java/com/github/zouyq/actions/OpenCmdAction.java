 ...
 * @since 21/8/5
 */
public class OpenCmdAction extends AnAction {

    public OpenCmdAction() {
        getTemplatePresentation().setIcon(Configuration.getIcon(IconType.CONSOLE));
    }
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        ComandTool.executeCmd(tVirtualFile, new ICommand() {
            public String command() {
                return ComandTool.openCmd(tVirtualFile);
            }
        });
    }
}
