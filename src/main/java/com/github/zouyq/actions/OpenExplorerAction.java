 ...
 * @since 21/8/4
 */
public class OpenExplorerAction extends AnAction {

    public OpenExplorerAction() {
        getTemplatePresentation().setIcon(Configuration.getIcon(IconType.EXPLORE));
    }
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        ComandTool.executeCmd(tVirtualFile, new ICommand() {
            public String command() {
                return ComandTool.showInExplore(tVirtualFile);
            }
        });
    }
}
